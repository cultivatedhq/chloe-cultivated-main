# Complete Bolt Workflow Setup - Ready to Deploy
...
## 🔄 **Step-by-Step Bolt Configuration**
...
### **Step 5: Process Data for Template**
...
### **Step 7: Check if Survey Has Responses**
**Block Type:** Conditional Logic
**Condition:** `{{ templateData.analytics.total_responses > 0 }}`

---

## 📊 **If Survey Has Responses (TRUE Branch)**

### **Step 8A: Generate PDF with PDF.co**
...
### **Step 9A: Send Email with PDF Report**
**Block Type:** Email
...
## 📭 **If Survey Has No Responses (FALSE Branch)**

### **Step 8B: Send No Responses Email**
**Block Type:** Email
**To:** `{{ templateData.survey.manager_email }}`
**CC:** `chloe@cultivatedhq.com.au`
...
### **Step 10: Mark Survey as Processed**
**Block Type:** Supabase SQL Query
**Query:**
```sql
...
Your Bolt workflow is now completely configured with:

✅ **Your actual PDF.co API key**
...
**Next Steps:**
1. Copy this configuration into Bolt
2. Test with a sample expired survey
3. Monitor the daily processing logs
4. Enjoy automated leadership reports! 🎉

The system will now automatically process expired surveys every day at 8:00 AM and send beautiful, professional PDF reports to managers!