...
function PulseCheckCreate() {
  ...
  const createSession = async () => {
    ...
    try {
      ...
      // Create the session with expiration date
      const sessionData = {
  ...
  const copyShareLink = () => {
    const link = `${window.location.origin}/pulsecheck/survey/${createdSession.id}`;
    navigator.clipboard.writeText(link);
    alert('Survey link copied to clipboard!');
  };

  const getSurveyLink = () => {
    return `${window.location.origin}/pulsecheck/survey/${createdSession?.id}`;
  };

  const getExpirationDate = () => {
    if (createdSession?.expires_at) {
      return new Date(createdSession.expires_at).toLocaleDateString();
    }
    // Calculate 3 days from now for display
      ...
      <nav className="bg-beige-50/95 backdrop-blur-sm shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <a href="/pulsecheck" className="text-2xl font-bold gradient-text font-poppins">Pulse Check</a>
            <div className="flex space-x-4 items-center">
              <a href="/pulsecheck" className="text-beige-500 hover:text-primary transition flex items-center">
            ...
            <div className="text-center mb-8">
              ...
              <div className="bg-primary/10 p-4 rounded-lg mt-6">
                <div className="flex items-center justify-center mb-2">
                  ...
                  <span className="font-semibold text-primary">Survey Duration</span>
                </div>
                <p className="text-sm text-beige-700">
                  You'll have <strong>3 days</strong> to collect responses.<br/>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-4 border border-beige-200 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                  placeholder="e.g., Q1 2024 Leadership Feedback"
                  required
                />
              </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-primary/10 p-6 rounded-2xl">
                <h3 className="font-bold mb-2 text-primary">Survey Timeline</h3>
                <div className="grid md:grid-cols-2 gap-4 text-sm text-beige-700">
                  ...
                  <div className="flex items-center">
                    ...
                    <span><strong>Closes:</strong> In 3 days ({getExpirationDate()})</span>
                  </div>
                </div>
                <div className="mt-4">
                  <h4 className="font-bold text-primary mb-2">What happens next?</h4>
                  <ul className="text-sm space-y-1 text-beige-700">
                    <li>• Your survey will be created and activated immediately</li>
                    <li>• You'll get a unique link to share with your team</li>
                    <li>• Team members can respond anonymously for 3 days</li>
                    <li>• The survey automatically closes after 3 days</li>
        ...
        {step === 4 && createdSession && (
          <div className="bg-white rounded-2xl p-8 shadow-lg text-center">
            ...
            <p className="text-lg text-beige-600 mb-8">
              Your feedback survey is ready and will automatically close in 3 days. Share the link below with your team to start collecting anonymous feedback.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-primary/10 p-6 rounded-lg">
                ...
                <p className="text-sm text-beige-600">Survey closes automatically on {getExpirationDate()}</p>
              </div>
              <div className="bg-primary/10 p-6 rounded-lg">
...
export default PulseCheckCreate;