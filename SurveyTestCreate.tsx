...
import { Plus, Settings, BarChart3, Download, Eye, Users, Calendar, ArrowLeft, Filter, Search, FileText, Lock, LogIn, RefreshCw } from 'lucide-react';
...
function PulseCheckAdmin() {
  ...
  const [formData, setFormData] = useState({
    ...
    manager_name: 'Chloe James (Admin)',
  ...
  const copyShareLink = (sessionId: string) => {
    const link = `${window.location.origin}/pulsecheck/survey/${sessionId}`;
    ...
    <div className="min-h-screen bg-beige-50 text-beige-800">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              <a href="/pulsecheck" className="text-2xl font-bold gradient-text font-poppins">Pulse Check Admin</a>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="flex justify-between items-center mb-12">
          <div>
            <h1 className="text-4xl font-bold mb-4 font-poppins">Admin Dashboard</h1>
            <p className="text-beige-600">Manage all feedback sessions and view analytics</p>
        ...
        {showCreateForm && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              <h2 className="text-2xl font-bold mb-6 font-poppins">Create New Private Session</h2>
              ...
              <form onSubmit={createSession} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-3 border border-beige-200 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                    placeholder="e.g., Q2 Feedback - Manager Jane"
                    required
                  />
                </div>
                      ...
                      <div key={index} className="flex items-start space-x-3">
                        ...
                        {formData.questions.length > 1 && (
                          <button
                            ...
                            className="text-red-500 hover:text-red-700 transition text-sm mt-3"
                          >
                            Remove
                          </button>
                        )}
            ...
            <div className="text-center py-12">
              ...
              <p className="text-beige-600 mb-6">
                {searchTerm || filterType !== 'all' 
                  ...
                  : 'Create your first session to start collecting anonymous feedback.'
                }
              </p>
              {!searchTerm && filterType === 'all' && (
                <button
            ...
            filteredSessions.map((session) => (
              <div key={session.id} className="bg-white rounded-2xl p-6 shadow-lg">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <a
                    href={`/pulsecheck/survey/${session.id}`}
                    target="_blank"
                  ...
                  {(session.response_count > 0) && (
                    <a
                      href={`/pulsecheck/results/${session.id}`}
...
export default PulseCheckAdmin;